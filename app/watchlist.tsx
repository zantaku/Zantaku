...
const MemoizedAnimeCard = memo(({ item, onPress }: { item: AnimeEntry; onPress: () => void }) => {
      ...
      <View style={styles.details}>
        ...
        <View style={styles.stats}>
          ...
          <View style={styles.badges}>
            ...
            <View style={[styles.statusBadge, { backgroundColor: currentTheme.colors.textSecondary }]}>
              <Text style={styles.statusText}>{item.media.format}</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.modalContainer, { backgroundColor: isDarkMode ? 'rgba(0,0,0,0.5)' : 'rgba(0,0,0,0.3)' }]}>
        <View style={[styles.modalContent, { 
          ...
          <ScrollView style={styles.filterScroll}>
            <FilterSection
              title="Lists"
              options={['All', 'Watching', 'Completed', 'Paused', 'Dropped', 'Planning']}
              stateKey="status"
